...
def upgrade():
    op.add_column(
        "energyvalue", sa.Column("advance_pay", sa.Integer(), nullable=True)
    )
    op.add_column("energyvalue", sa.Column("fee", sa.Integer(), nullable=True))
    op.add_column(
        "energyvalue", sa.Column("price", sa.Integer(), nullable=True)
    )
    op.add_column(
        "energyvalue", sa.Column("usage", sa.Integer(), nullable=True)
    )
    op.add_column(
        "energyvalue", sa.Column("whole_price", sa.Integer(), nullable=True)
    )
    op.add_column(
        "energyvalue", sa.Column("discounted", sa.Boolean(), nullable=True)
    )
